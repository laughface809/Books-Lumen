...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"data"},"logout":{"url":"/logout","method":"post"},"user":{"url":"/users/login","method":"get","propertyName":"data"}},"tokenRequired":true,"tokenType":"Bearer ","_name":"local"}))
